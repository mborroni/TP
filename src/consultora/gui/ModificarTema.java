...
public class ModificarTema extends JPanel {
	...
	public ModificarTema(Tema t) {
		...
		palabraClavetxtFld = new JTextField(t.getPalabraClave());
		...
		codigotxtFld = new JTextField(t.getCodigo());
		...
		fechaInicio = new JDateChooser(java.sql.Date.valueOf(t.getInicio()));
		...
		fechaFin = new JDateChooser(java.sql.Date.valueOf(t.getFin()));
		...
		descripciontxtArea = new JTextArea(t.getDescripcion());
